...
mod tests {
    ...
    #[test]
    fn test_serde_nvidia_branch_defaults_when_omitted() {
        // An nvidia object with no branch should deserialize to the default (lts),
        // not fail with a missing-field error.
        let test_json = r#"{"nvidia":{}}"#;
